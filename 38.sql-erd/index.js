...
const pupilsRouter = require("./routers/pupils");
...
app.use("/classes", classesRouter); // checked
app.use("/pupils", pupilsRouter); // checked
app.use("/subjects", subjectsRouter); // checked
app.use("/teachers", teachersRouter); // checked
